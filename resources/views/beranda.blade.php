<x-app-layout>
    ...
    <div class="bg-white">
        ...
        {{-- Search --}}
        <div class="relative" style="margin-left: 35%; margin-right:35%">
        ...
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                <a href="#" class="group">
                    <div
                        class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-4 xl:aspect-w-4">
    ...
    <footer class="bg-white">
        <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
            <div class="sm:flex sm:items-center sm:justify-center">
                ...
                <ul class="mt-16 flex justify-center gap-8 sm:mt-9 sm:justify-end ">
                    <li>
            ...
            <div class="grid grid-cols-1 gap-8 border-t border-gray-100 pt-2 sm:grid-cols-2 lg:grid-cols-4 lg:pt-8">
                <div>
